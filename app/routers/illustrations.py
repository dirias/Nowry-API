...
async def generate_diagram(
    ...
    # Free-tier cap check (D-10, T-6-01)
    if tier == "free":
    ...
    # Increment counter atomically BEFORE LLM call — race-condition safe (Pitfall 3)
    ...
    try:
        ...
        # Decrement on LLM failure — do not penalize free users for AI errors
        await books_collection.update_one(
            {"_id": ObjectId(book_id)},
            {"$inc": {"illustration_count": -1}},
        )
